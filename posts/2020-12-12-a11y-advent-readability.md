---
title: 'A11y Advent Day 12: Readability'
...
{% assign footnote_wcag_color = "It has been repeatedly shown that <a href='https://mobile.twitter.com/adamwathan/status/1304490267769221121'>the contrast model is flawed</a>. It is <a href='https://github.com/w3c/wcag/issues/695'>known and is being addressed</a>." %}
...
- Ensure decent contrast. Relying on the [WCAG contrast guidelines](https://css-tricks.com/understanding-web-accessibility-color-contrast-guidelines-and-ratios/) is a good place to start (even though the {% footnoteref "wcag_color" footnote_wcag_color %}WCAG contrast guidelines are not perfect{% endfootnoteref %}).
