...
tags:
  ...
  - JavaScript
  - Open Source
image: /assets/images/whats-up-at-browserhacks/validity.jpg
---
...
We thought it would be cool if you could link to a specific hack. It would make it easier to show a hack to someone, rather than copy/pasting or saying _Section IE, sub-section Media hacks, 3rd hack on the 2nd column_.
...
{% render "figure.liquid",
  src: "/assets/images/whats-up-at-browserhacks/validity.jpg",
  caption: "Display hacks validity and CSS Lint errors"
%}
...
We’ve also done a few little things, starting by _improving_ the design. The header is now lighter, and the search bar only is fixed on scroll. We’d like opinion on this. You like it? You don’t? Why?
