...
{% render "figure.liquid",
  src: "/assets/images/why-element-queries-matter/thumbs-list.png",
  caption: "A sketch of our main component",
  lazy: false
%}
...
And when switching from 1 to 2 to 3 columns, the viewport’s width has absolutely no impact on anything. It’s always the same. We don’t care about the viewport’s size at the moment, we need to know how much space is available for the component depending on the layout used (and in a lesser extend the meta-component used).
...
{% render "codepen.liquid",
  slug: "cfdf5410e622f1e5f41035232de4260c",
  height: 460
%}
...
However, they still come up with a couple of pitfalls like infinite loops and non-sense declarations. Imagine you tell a component to have a width of 399px when it is 400+ pixels large. This is wild. This is probably because of such things element queries are still not natively implemented anywhere.
