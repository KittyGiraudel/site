...
The other day, I redesigned my [project portfolio](/projects/) and my [speaker page](/talks/) to be more inviting and visual, and with that I had to look into image optimization again. This short article to sum up what I’ve done.
...
2. During a build, the image plugin will skip a transform if the output file already exists. So, when building on CI, the files that were restored in `.cache` won’t be recompiled.
...
Nothing ground-breaking and nothing unique to this website either. Zach Leat is the real MVP and did everything with his great work on Eleventy. 
