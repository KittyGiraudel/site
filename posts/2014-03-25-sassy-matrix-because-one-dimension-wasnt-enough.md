...
If you wonder whether I succeeded or failed, I succeeded. You can check [the code](https://gist.github.com/KittyGiraudel/8334461) on GitHub. So if you ever wanted to calculate the Levenshtein distance between two strings in Sass, now you can. Useless thus essential.
...
{% callout %}I like to prefix private functions with an underscore. By “private” I mean functions that are not supposed to be called from the outside. Unfortunately Sass doesn’t provide any way to privatize stuff.{% endcallout %}
...
Be sure to give it a try. Plus, I’d love to have some feedback!
