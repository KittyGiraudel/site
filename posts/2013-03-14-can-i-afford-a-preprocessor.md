...
A couple of days ago, the famous French frontend developer [Vincent De Oliveira](https://twitter.com/iamvdo) has written a blog post called [Why I don’t use CSS preprocessors](https://blog.iamvdo.me/post/45259636008/pourquoi-je-nutilise-pas-les-preprocesseurs-css) (_<span lang="fr">Pourquoi je n’utilise pas les préprocesseurs CSS</span>_). If you can read French, or stand [Google Translate](https://translate.google.fr/translate?sl=fr&tl=en&js=n&prev=_t&hl=fr&ie=UTF-8&eotf=1&u=http%3A%2F%2Fblog.iamvdo.me%2Fpost%2F45259636008%2Fpourquoi-je-nutilise-pas-les-preprocesseurs-css), then I highly recommend you this article, full of good points and interesting opinions.
