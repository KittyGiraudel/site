...
tags:
  - Writing
  - Process
image: /assets/images/writing-in-sublime-text/preview.png
deprecated: true
---

I used to write a lot.<sup>[citation needed]</sup> I have spent countless hours writing articles, books, mails and what else. And for all that, I use a single tool: Sublime Text. As far as I am concerned, Sublime Text is the perfect environment for writing, especially tech writing. In this article, I’d like to show you my setup so you can use Sublime Text for writing as well.
...
{% render "figure.liquid",
  src: "/assets/images/writing-in-sublime-text/sub-highlighting.png",
  caption: "Lines 31 to 37 are being highlighted as SCSS"
%}
...
{% render "figure.liquid",
  src: "/assets/images/writing-in-sublime-text/preview-in-browser.png",
  caption: "This article previewed in Chrome locally thanks to Markdown Preview"
%}
...
{% render "figure.liquid",
  src: "/assets/images/writing-in-sublime-text/sidebar-enhancements.png",
  caption: "Right click on file provides a lot of new options thanks to Sidebar Enhancements"
%}
