...
{% callout %}You can find the [complete code for the plugin](https://github.com/KittyGiraudel/site/blob/main/plugins/post-stats.js) on GitHub. Be warned: there is a fair bit of proprietary logic, and most of it was written by Cursor. Still, you should be able to reuse most of it if you wanted.{% endcallout %}
