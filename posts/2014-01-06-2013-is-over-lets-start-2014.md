...
description: A retrospective post about my year 2013, and what I have accomplished
tags:
  - Retrospective
---
...
After several years of school &mdash; the last two being in a work-based study (half part school, half part work) &mdash; I got hired at Tootici (Moirans, France) as a frontend developer as a full-time job.
...
### … attented to a conference as a speaker.

Actually 2013 is the year I attented a conference for the first time at all. Attending to a conference was a great experience; being able to be there as a speaker was even more awesome. Last june I had the opportunity to [talk about Sass at KiwiParty](/2013/07/01/feedback-on-my-first-conf/) (Strasbourg, France) in front of a very receptive audience.

{% render "figure.liquid",
  src: "/assets/images/feedbacks-kiwiparty/kitty-giraudel.jpg",
  caption: "Focus - photo by <a href='http://alixlucas.com'>Alix Lucas</a>",
  lazy: false
%}
...
Then things got even better once I started understanding what the prototype is, and how to use it. I’ve been practicing a little bit with this so far with [Countdown.js](https://github.com/KittyGiraudel/Countdown.js) and [CRUD.js](https://github.com/KittyGiraudel/CRUD.js). Comments welcome. ;)

### … launched Browserhacks.

[Browserhacks](/projects/browserhacks/) has been my first real project, with a purpose, issues, versions, features and so on. Launched in early 2013 with [Tim Pietrusky](https://twitter.com/timpietrusky) we are very glad with what we’ve come up with so far (which is even more true since the fresh redesign from [Joshua Hibbert](https://twitter.com/_joshnh)).
