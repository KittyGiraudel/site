...
{% render "figure.liquid",
  src: "/assets/images/giving-a-frontend-workshop/recipe-example.png",
  caption: "Example of a recipe that I prepared for the workshop",
  lazy: false
%}
...
{% render "figure.liquid",
  src: "/assets/images/giving-a-frontend-workshop/recipe-1.png",
  caption: "Screenshots of some participants’ recipes",
  alt: "Screenshot of a participant’s recipe"
%}
