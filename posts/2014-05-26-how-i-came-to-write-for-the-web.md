...
Thankfully, John gave me some extra opportunities to release more interesting articles on The Sass Way, including a cool one about [how to programmatically go from one color to another](/2014/01/30/programmatically-go-from-one-color-to-another-with-sass/) which is (in my opinion) quite neat, especially if you’re interested in how colors work.
