...
This is where things get very interesting. And quite complicated as well. I think the best way to explain this kind of stuff is to use an example. I’ll use the same I talked about in [my Sass talk at KiwiParty](https://hugogiraudel.com/2013/07/01/feedbacks-kiwiparty/) last month.
