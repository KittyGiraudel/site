...
I once had to use `sin()` in order to make a [mixin for a pure CSS 6-points star](/2013/02/18/sass-mixin-star/) but that’s pretty much it. If you happen to have a real live use case for one of those functions, I’d be more than pleased to know more about it.
