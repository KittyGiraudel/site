...
<section>   
<h1>{{ page.title }}</h1>
<p class="date">{{ page.date | date: "%d %B %Y" }}, <a href="tetris.html#disqus_thread" title="How I built a Tetris with C# & Unity" class='comment-count'></a></p>
...
<img src="../images/tetris.jpg" class="img-right mt15">
...
<p>I started with the easy part: creating the 7 different bricks prefabs + the frame. It was more like Unity tooling here. I shortly after involved some C# to make a brick move when pressing left <i class="icon-arrow-left"></i> and right <i class="icon-arrow-right"></i> arrows.</p>

<p>I quickly managed to have bricks falling one after each other, with the ability to move and rotate them with arrow keys. However, they were not stacking, they were passing through. So bricks were falling from the sky, but you couldn't really play Tetris. You could watch them overlapping eachother on the bottom line. This is were things got harder.</p>-->
...
<img src="../images/tetris-camera.jpg" class="img-right mt0 w200">
