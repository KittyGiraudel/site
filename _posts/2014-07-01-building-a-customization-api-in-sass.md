...
_Note: If you’re unfamiliar with using maps as arguments, [Kitty wrote up a pretty nifty article on that](https://www.sitepoint.com/using-sass-maps/), as well as many other use-cases for maps._
