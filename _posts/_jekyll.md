...
<p>Back then, I had a look at Jekyll and it looked nice but overly complicated -at least to me. I'm really not that smart when you put CSS aside. But it seemed to be quite what I was looking for so I thought I should give a try.</p>
...
<p>Thus, trying to reach hugogiraudel.com/blog/css-gradients (old URL) automagically redirects to hugogiraudel.com/2013/02/04/css-gradients/. Easy peasy.</p>
...
<p>There are still a couple of things to take care of like finding a way to preview articles before releasing them without running Jekyll or displaying Codrops articles on the home page but I think it is a fairly good start, don't you think?</p>
