...
<section>
<h1>{{ page.title }}</h1>
<p class="date">{{ page.date | date: "%d %B %Y" }}, <a href="http://hugogiraudel.com/blog/process.html#disqus_thread" class='comment-count'></a></p>
...
<script>var disqus_url = "http://hugogiraudel.com/blog/process.html";</script>
