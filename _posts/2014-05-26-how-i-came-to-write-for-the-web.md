...
Obviously I said _yes_ and got to write quite [a couple of posts for Codrops](http://tympanus.net/codrops/author/hugogiraudel/) between September 2012 and July 2013, including some pretty popular ones like [Troubleshooting CSS](http://tympanus.net/codrops/2013/07/17/troubleshooting-css/). After a dozen articles over a year, I realized Codrops was looking for design-related posts while I felt more technic-focused. As a matter of facts, my last posts at Codrops were quite technical (dealing with CSS counters, `clip()`, click events...).
