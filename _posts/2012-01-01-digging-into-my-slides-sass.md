...
<p><span class="fontawesome-comments icon-left" style="color: #aaa"></span>Is there a performance difference between <code>.message</code> and <code>.message-error, .message-ok, .message-info, .message-warn</code>?</p>
...
<p><span class="fontawesome-comments icon-left" style="color: #aaa"></span>Your @media mixin outputs a media-query block every time you use it. Ain't you afraid of performance issues?</p>
...
<p><span class="fontawesome-comments icon-left" style="color: #aaa"></span><a href="http://compass-style.org/">Compass</a> or <a href="http://bourbon.io/">Bourbon</a>?</p>
...
<p><span class="fontawesome-comments icon-left" style="color: #aaa"></span>Do you think we will ever be able to connect Sass to some kind of database to auto-supply lists or something?</p>
