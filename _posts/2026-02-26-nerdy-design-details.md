...
<button class="ThemeButton ThemeButton--demo" type="button">
  <span class="visually-hidden">Dark mode</span>
  <svg class="ThemeButton__icon ThemeButton__icon--light" data-theme="light" xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
