...
{% callout %}I won’t explain the syntax in this article. If you want to understand how works the Grid Layout, please have a look at [CSS-Tricks' Almanac entry](https://css-tricks.com/almanac/properties/g/grid/).{% endcallout %}
